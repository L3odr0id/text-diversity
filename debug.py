...
#             main_calc_info=calc_info,
#             eps=eps,
#             max_tries=max_tries,
#             tests_runner_folder=tests_runner_folder,
#             tests_runner=TestsRunner(command=runner_cmd),
...
def main() -> None:
    ...
    tests_runner_folder = TestsRunnerFolder(path=test_runner_output_path)
