...
class PctFilter:
    def __init__(
        ...
        self.current_metric_value = metric.value(text_set_distances)
    ...
    def metric_value_without_idxs(self, idxs_to_remove: List[int]) -> float:
        return metric_value_without_idxs(
            self.text_set_distances,
            self.metric,
            idxs_to_remove,
        )
